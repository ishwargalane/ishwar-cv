...
baseurl: "ishwar-cv" # the subpath of your site, e.g. /blog/
url: "https://kloudwiz.com" # the base hostname & protocol for your site
```
...
4. Start and http-server in the folder `_site` or  `bundle exec jekyll serve`
